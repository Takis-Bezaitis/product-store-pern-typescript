...
function ProductPage() {
  ...
  const { fetchProduct, updateProduct, deleteProduct, formData, setFormData, currentProduct, loading, error } = useProductStore();
            ...
            >
              ...
              <div className="flex justify-between mt-8">
                ...
                <button 
                  ...
                  disabled={loading || !formData.image || !formData.name || !formData.price}
